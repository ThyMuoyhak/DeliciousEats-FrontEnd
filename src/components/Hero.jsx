      ...
      <div className="hero-container">
        <div className="hero-content">
          ...
          <p className="hero-description">
            Experience our curated selection of next-gen beverages and energy formulas.
            Engineered for maximum refreshment and delivered at lightspeed to your location.
          </p>
          ...
          <Link to="/products" className="hero-cta-secondary">
            <svg xmlns="http://www.w3.org/2000/svg" className="hero-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="hero-features">
            <div className="hero-feature-item">
              <div className="feature-icon-container">
                <svg xmlns="http://www.w3.org/2000/svg" className="hero-feature-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="hero-product-showcase">
            <div className="hero-product-item hero-product-main">
              ...
              <div className="hero-product-image-wrapper">
                ...
                <div className="hero-product-image">
                  <img src="https://www.swirecocacola.com/sbcorpweb/uploads/newsletter/images/source/402660493_1000.jpg" alt="Coca-Cola bottle" />
                </div>
              </div>
              <div className="hero-product-info">
                <h3 className="hero-product-name">Coca-Cola Classic</h3>
                <div className="hero-product-price">$6.99</div>
              </div>
            </div>
            ...
            <div className="hero-product-item hero-product-secondary hero-product-2">
              <div className="hero-product-image-wrapper">
                ...
                <img src="https://www.thedrinksbusiness.com/content/uploads/2022/06/2519EE4F-7B22-4A4B-B22A-1040C324D784-640x592.jpeg" alt="Energy drink" />
              </div>
            </div>
            ...
            <div className="hero-product-item hero-product-secondary hero-product-3">
              <div className="hero-product-image-wrapper">
                <div className="hero-product-glow small"></div>
                <img src="https://fabnews.live/wp-content/uploads/2023/11/Sting-Red_Cambodia-Can-min.png" alt="Sting energy drink" />
              </div>
            </div>
            
            <div className="hero-product-floating-elements">
              <div className="hero-floating-element hero-float-1">
                <svg xmlns="http://www.w3.org/2000/svg" className="hero-element-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
